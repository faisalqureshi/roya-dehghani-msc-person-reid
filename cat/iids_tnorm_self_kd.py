...
sys.path.append( os.path.abspath(os.path.join(os.getcwd(), '../iids')) )
...
def main(args):
    ...
    camera_number = {"market1501": 6, "dukemtmc": 8, "msmt17": 15}
...
#and 2 times for training inter model
    ...
    for cluster_epoch in range(args.cluster_epochs):
        ...
        cluster_result = get_inter_cam_cluster_result_tnorm(model,
                                                            train_loader,
                                                            args.eph_stage2,
                                                            args.linkage,
                                                            mix_rate,
