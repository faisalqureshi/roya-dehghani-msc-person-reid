...
def removeBg(imagePath,fileName):
    ...
    unique_filename = fileName+".png"
    cv2.imwrite(inputs_dir+unique_filename, img)
    # processing
    ...
    dn = (pred-mi)/(ma-mi)
    pred = dn
    save_output(inputs_dir+unique_filename, unique_filename, pred, results_dir, 'image')
    save_output(inputs_dir+unique_filename, unique_filename, pred, masks_dir, 'mask')
    return "---Success---"
# ------- Load Trained Model --------
print("---Loading Model---")
model_name = 'u2net'
...
def listFiles(dir):
    ...
    for fileName in folder:
        ...
        print(removeBg(imgPath,fileName))
               
#listFiles("/Users/nehaejaz/Documents/thesis/Image-Background-Remover-Python/hazelnut/test/multiple_obj/good")
listFiles("/home/rdehghani/data/market1501/original_images")
