...
#roya: this class just renmaed images in a standard format and cretaes images,meta and splits files
class Market1501(Dataset):
    ...
    def download(self):
        #if there are three folder(images,meta.json,splits.json) in root addrees
        ...
        gallery_pids, gallery_names = register('bounding_box_test')
        query_pids, query_names = register('query')
